...
├── patterns/                         ← 34 files (see table below)
├── lessons/
...
### E. Application outsourcing / AMS (Program Line J, 2026-08)

```text
Local application-outsourcing training (not archived)
        ↓ generalize
...
```text
Local infrastructure-outsourcing SA training — not archived
        ↓ generalize
...
```text
Local SI SA / delivery-lead and multi-tower delivery training — not archived
        ↓ generalize
